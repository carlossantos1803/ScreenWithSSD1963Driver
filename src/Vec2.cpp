...
/*void map_float_to_int(float value)
{
	this->x *= value;
	this->y *= value;
}*/
...
void Vec2::speed(int32_t _velocity, int32_t _tita)
{
	this->x = _velocity*cos(_tita*PI / 180.0);  
	this->y = _velocity*sin(_tita*PI / 180.0);
}
		
void Vec2::printVec(const char *_msg) //String *_msg)
{
	Serial.printf("%s{%.2f,%.2f}\n",_msg,this->x,this->y);
}

//void Vec2::printVec(const String _msg)
//{
//	Serial.printf("%s{%d,%d}\n",_msg,this->x,this->y);
//}
